...
load_model = st.sidebar.button("Load the model")
...
if selected_choice == "Generative":
    ...
    if load_model:
        ...
        text2image = StableDiffusionPipeline.from_pretrained("stabilityai/stable-diffusion-2-base", scheduler=scheduler_text2image_base, 
        ...
        with col1:
            ...
            with col2:
                ...
                if ok_button:
                    ...
                    image2 = pipe2(prompt=altered_prompt, image=img, mask_image=canvas_result.image_data,
                                   width=width, height=height,num_inference_steps=20).images[0]
